							...
							<tr>
								...
								<td class="pl-5 pb-2">
									<div class="input-group">
										...
										<input type="text" 
											pattern="01[0-9][0-9]{7,8}|0[2-9][0-9]{7,8}" 
											title="Enter a valid Malaysian phone number (e.g., 0123456789 or 0345678901)" 
									...
									<small class="form-text text-muted">Enter numbers only: 01xxxxxxxx (mobile) or 0xxxxxxxx (landline)</small>
								</td>
							</tr>
						</tbody>
					</table>
