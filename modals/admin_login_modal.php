                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" type="password" name="password" id="adminPassword" placeholder="Enter Password" required/>
                        ...
                        <div class="text-right">
                            <a href="#" data-toggle="modal" data-target="#adminForgotPasswordModal" data-dismiss="modal">Forgot Password?</a>
                        </div>
                    </div>
...
<div class="modal fade" id="adminForgotPasswordModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-key"></i> Forgot Password - Admin</h5>
